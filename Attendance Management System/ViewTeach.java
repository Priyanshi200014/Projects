...
import java.sql.*;
import javax.swing.*;
public class ViewTeach extends HttpServlet
{
  ...
  public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
   {
	...
	try
	{
		...
		{
           PreparedStatement ps = c.prepareStatement("select * from teacherslist where SubjectName = ?");
		...
		else if(req.getParameter("addTeach")!=null)
		{
			out.print("<p class='user_name'>");
			out.print(UN);
			out.print("</p>");
